...
!function($){
  ...
  * ================================= */
  ...
  , select: function () {
      ...
      var event_id = this.$element.attr('event_id');
      var rank = this.$element.attr('rank');
      ...
      $.ajax({
        type: "POST",
        url: "/results",
        data: { 'result[event]': event_id, 'result[country]': country, 'result[rank]': rank},
        statusCode: {
          404: function() {
            $(status_color).attr('class', 'control-group error');
            alert_me("Virhe!","Tuloksen lisäyksessä tapahtui virhe, tarkista oikeinkirjoitus, tai yritä myöhemmin uudelleen...",true, false);
          },
          204: function() {

            $(flag_holder).html("<img height='20' src='/assets/countries/" + (jQuery.inArray(country, countries_array)+1) + ".png' width='34'>")
            alert_me("Hienoa!","Tulos lisättiin onnistuneesti.",true, true);
            $(status_color).attr('class', 'control-group success');
          },
          200: function() {

            $(flag_holder).html("<img height='20' src='/assets/countries/" + (jQuery.inArray(country, countries_array)+1) + ".png' width='34'>")
            alert_me("Hienoa!","Tulos päivitettiin onnistuneesti!.",true, true);
            $(status_color).attr('class', 'control-group success');
